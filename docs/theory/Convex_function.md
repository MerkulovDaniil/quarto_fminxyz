...
>$$
>
>which represents the epigraph of the function $ x \mapsto \Vert x \Vert $. This set is called the cone norm. According to statement above, the set $ K $ is convex.
>
...
>$$
>
>The example of function, that satisfy PL-condition, but is not convex.
>$$
...
* Example pf Pl non-convex function [Open in Colab](https://colab.research.google.com/github/MerkulovDaniil/optim/blob/master/assets/Notebooks/PL_function.ipynb){: .btn }
